...
#                    minibatch_x=rotateImage(minibatch_x)                
 ...
 #                   saver.save(sess, "mlp_logs/model-checkpoint", global_step=global_step)
            ...
            plt.xticks([], [])
            plt.yticks([], [])
            plt.savefig('C:/Users/Deepak/Dropbox/Deep Learning/Project 2/Part B2 Output/Original_Rotated.jpg')
            ...
            with open('C:/Users/Deepak/Dropbox/Deep Learning/Project 2/Part B2 Output/Accuracy.txt', 'w') as f:
        ...
        output_test = sess.run(argMax_output, feed_dict={x: rotateImage(mnist.test.images), y: mnist.test.labels})
...
#            tb.set_yticks([])
        ...
        plt.show()
        plt.savefig('C:/Users/Deepak/Dropbox/Deep Learning/Project 2/Part B2 Output/Confusion_Matrix.jpg')
